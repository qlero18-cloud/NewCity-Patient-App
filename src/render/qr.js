...
export const QR_VERSIONS = Object.fromEntries(
...
export const QR_MAX_BYTES = VERSIONS_ASCENDENTES[VERSIONS_ASCENDENTES.length - 1].maxBytes;

// La versión más chica donde quepa: ver el comentario de cabecera sobre por
// qué no se usa siempre la más grande.
export function versionForBytes(numBytes) {
...
export function generateQrMatrix(text, { version } = {}) {
